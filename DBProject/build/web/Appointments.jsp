...
ResultSet rs=st.executeQuery("SELECT * FROM Doctor, Appointment,Patient where Appointment.PatientID='"+PatientID+"'"
        + " and Appointment.DoctorID=Doctor.DoctorID and Patient.PatientID=Appointment.PatientID order by AdmittanceTime asc "); 
while(rs.next()) 
{ 
...
String AppointmentID =rs.getString(10);
...
<col width="80"><col width="200"><col width="200"><col width="350"><col width="150"><col width="200"><col width="50">
<tr>
...
<td align="center">
<a href ="edit.jsp?AppointmentID=<%=AppointmentID%>">Edit</a>
</td>
</tr>
</table>
</div>
