                            ...
                            <div class="col-lg-6">
                                   <div class="panel-body" background-color:transparent style="margin-top: 200px;margin-left: 100px; width: 100%">
                                       ...
                                       <center><h4 <%=request.getAttribute("reg") %></h4></center>
                                        <center><h4>Update Your Patient Appointment </h4></center><hr>
                                         <div class="col-lg-6">
                                        <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                                            <img src="doc.jpg" style="width: 200px; height: 200px;margin-bottom: 9px;" class="img img-responsive" alt="" />
                                        </div>
                                    </div>
                                        <form action="UpdatePApt.jsp"  method="post" name="form" id="form" role="form" class="contactForm lead">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Select Discharge Date" name="DischargeTime" id="dob" required="" class="datepicker form-control input-md">
                                                </div>
                                            </div> 
                                                     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
