                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="panel-body" background-color:transparent style="margin-top: 50px;width: 100%">
                                    ...
                                    <center><h4>Lab Exam Form</h4></center><hr>
                                    <div class="col-lg-6">
                                        <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                                            <img src="doc.jpg" style="width: 200px;height: 200px;margin-bottom: 9px;" class="img img-responsive" alt="" />
                                        </div>
                                    </div>
                                    <form action="Exam.jsp"  method="post" name="form" id="form" role="form" class="contactForm lead">
                                        <div class="row" style="margin-top: 0px;"> 
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    <label>Patient ID</label>
                                                    <input type="text" placeholder="Patient ID" name="PatientID" id="name" class="form-control input-md" required="" title="Put ID">
                                             ...
                                             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Lab Time" name="LabTime" id="dob" required="" class="datepicker form-control input-md">
                                                </div>
                                            </div>  
                                                ...
                                                <div class="form-group">
                                                    <label>Order By</label>
                                                     <select name="DoctorID" id="med" class="form-control" required="">
                                                        <option selected="" value="" disabled="">Department of Order</option>                                                        
