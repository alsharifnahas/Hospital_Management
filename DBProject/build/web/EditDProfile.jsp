                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="table" style="margin-top: 150px; background-color:transparent; height: 50%; margin-left: -100px; width: 400%">
                                    <center><h1><span class="bold">Your Current Profile</span></h1></center>
                                                ...
                                                <%
                                                    ...
                                                    ResultSet rs = st.executeQuery("SELECT * FROM Doctor, [Login] where Doctor.DoctorID='" + DoctorID + "' and Doctor.DoctorID=Login.DoctorID");
                                                    while (rs.next()) {
                                                        ...
                                                        String LoginPassword = rs.getString(12);
                            ...
                            <div class="col-lg-6">
                                <div class="panel-body" background-color:transparent style="margin-top: 100px;margin-left: 100px; width: 100%">
                                     <center><h4 <%=request.getAttribute("errorMsg") %></h4></center>
                                      <center><h4 <%=request.getAttribute("reg") %></h4></center>
                                    <center><h4>Doctor Update Form</h4></center><hr>
                                    <form action="DoctorUpdate.jsp"  method="post" name="form" id="form" role="form" class="contactForm lead">
                                        <div class="row" style="margin-top: 0px;">                           
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    <label>Password</label>
                                                    <input type="password" placeholder="Password" id="password" name="LoginPassword" class="form-control input-md" required="" title="complete password">
