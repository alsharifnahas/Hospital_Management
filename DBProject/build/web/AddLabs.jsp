                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="panel-body" background-color:transparent style="margin-top: 50px;width: 100%">
                                    ...
                                    <center><h4>Lab Result Form</h4></center><hr>
                                    <div class="col-lg-6">
                                        <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                                            <img src="doc.jpg" style="width: 200px;height: 200px;margin-bottom: 9px;" class="img img-responsive" alt="" />
                                        </div>
                                    </div>
                                    <form action="InsertLab.jsp"  method="post" name="form" id="form" role="form" class="contactForm lead">
                                        <div class="row" style="margin-top: 0px;"> 
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    <label>Lab Order #</label>
                                                    <input type="text" placeholder="Lab Test ID" name="LabTestID" id="name" class="form-control input-md" required="" title="Put ID">
                                                ...
                                                <div class="form-group">
                                                   <label>Lab type</label>
                                                    <select name="MeasurementID" id="med" class="form-control" required="">
                                                        <option selected="" value="" disabled="">Lab department</option>                                                        
                                                       <option value="1"> weight</option>
                                                       <option value="2">height</option>
                                                       <option value="3">systolic BP</option>
                                                       <option value="4">diastolic BP</option>
                                                       <option value="5">temperature</option>
                                                       <option value="6">LDL cholesterol</option>
                                                       <option value="7">HDL cholesterol</option>
                                                       <option value="8">heartrate</option>                                                       
                                                       </select>
                                                    <div class="validation"></div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    <label>Lab Test Value</label>
                                                    <input type="text" placeholder="Value" name="Value" id="name" class="form-control input-md" required="" title="Enter Value">
                                                    <div class="validation"></div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    <label>Range OK</label>
                                                    <input type="text" placeholder="Range" name="RangeOK" id="name" class="form-control input-md" required="" title="Last name can not be blank">
                                                    <div class="validation"></div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    <label>Comment</label>
                                                    <input type="text" placeholder="Doctor Comment" name="Comment" id="name" class="form-control input-md" required="" title="Last name can not be blank">
                                                    <div class="validation"></div>
                                                </div>
                                            </div>
                                        </div>
