                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                                        <img src="img.png" class="img img-responsive" alt=""  style="margin-top: 130px;height: 100%; width: 100%;"/>
                                    </div>
                                </div><br><br><br>
                                <div class="col-lg-6">
                                    <div class="panel-body" style="margin-top: 80px;height: 100%; width: 100%">
<center><h4 <%=request.getAttribute("registered") %></h4></center>
                                    <img src="dz.jpg" style="width: 100%;margin-top: 10px;height: 80%;" class="img img-responsive" alt="" />                                   
                                   <center><h3>Welcome To Doctor Zone</h3></center>            
                                   </div>
                            </div>
                        </div>
                    </div>
