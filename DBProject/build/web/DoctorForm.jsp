                                ...
                                <div class="col-lg-6">
                                    <div class="panel-body" background-color:transparent style="margin-top: 50px;width: 100%">
                                       <center><h4 <%=request.getAttribute("errorMess") %></h4></center>
                                        <center><h4>Doctor Registration Form</h4></center><hr>
                                        <form action="DoctorRegister.jsp"  method="post" name="form" id="form" role="form" class="contactForm lead">
                                            <div class="row" style="margin-top: 0px;">
                                             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    <label>Login Name</label>
                                                    <input type="text" placeholder="UserName"  name="LoginName" id="name" class="form-control input-md" required="" title="Create Doctor User Name">
                                                ...
                                                <label>Social Security No</label>
                                                    <input type="password" placeholder="SSN"  name="SSN" pattern ="\d{9}" id="name" class="form-control input-md" required="" title="Social Security Number contains only 9 digits.">
                                                    <div class="validation"></div>
                                                </div>
                                            </div>                              
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" placeholder="Password" id="password" name="LoginPassword" class="form-control input-md" required="" title="Password should contain at least 1 Uppercase ,1 Lowercase and digit and minimum of 6 character.">
                                                    <div class="validation"></div>
                                                </div>
                                            </div>
                                           <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Department Name</label>
                                                     <select name="DepartmentID" id="med" class="form-control" required="">
                                                        <option selected="" value="" disabled="">Department Assigned To</option>                                                        
