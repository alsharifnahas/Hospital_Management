...
ResultSet rs=st.executeQuery("SELECT Distinct Patient.FirstName, Patient.LastName, Patient.DOB, Patient.Address, Patient.Phone,"
        + " Patient.Gender FROM Patient, Appointment where Patient.PatientID=Appointment.PatientID"); 
while(rs.next()) 
{ 
...
<col width="200"><col width="200"><col width="150"><col width="350"><col width="200"><col width="100"><col width="100">
<tr>
...
<td align="center">
<a href="AddAppointment.jsp">Add another Appointment</a>
</td>
</tr>
</table>
</div>
