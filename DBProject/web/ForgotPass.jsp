                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="panel-body" style="margin-top: 80px; height: 100%; width: 100%">
                                        <center><h4 <%=request.getAttribute("pass") %></h4></center>
                                        <center><h3>Patient Forgot Password Form</h3></center><hr>

                                    <div class="col-lg-6">
                                        <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                                            <img src="p.jpg" style="width: 190px;height: 190px;margin-bottom: 9px;" class="img img-responsive" alt="" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input required="" placeholder="User Name" type="text" title="Enter UserName" name="LogonName"  class="form-control input-md">
                                              ...
                                              <label>Patient SSN</label>
                                                    <input required="" placeholder="Patient SSN"  pattern="\d{9}"  id="ssn" type="password" title="Enter Patient SSN" name="SSN" title ="SSN is 9 digits ONLY" class="form-control input-md">
                                                    <div class="validation"></div>
                                                </div>
                                            </div>
                                            </div>
