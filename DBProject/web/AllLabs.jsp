        ...
        <div class="example3">
            <nav class="navbar navbar-inverse navbar-static-top" style="background-color: whitesmoke;">
                ...
                <!--/.container-fluid -->
                                ...
                                <center><h1><span class="bold">Labs Ordered</span></h1></center>
...
ResultSet rs=st.executeQuery("SELECT LastName,LabTime, Measurements.Name, Measurements.LowRange, MeasuredResults.Value,"
        + " Measurements.HighRange, MeasuredResults.Comment FROM Patient, LabTesting, Measurements, MeasuredResults"
        + " where Patient.PatientID=LabTesting.PatientID and LabTesting.OrderBy='"+DoctorID+"' "
                + "and Measurements.MeasurementID= MeasuredResults.MeasurementID and"
                + " LabTesting.LabTestID=MeasuredResults.LabTestID order by LabTesting.LabTime desc"); 
while(rs.next()) 
{ 
String LastName  =rs.getString(1);
String LabTime =rs.getString(2);
String Name =rs.getString(3);
String LowRange =rs.getString(4);
String Value =rs.getString(5);
String HighRange =rs.getString(6);
String Comment =rs.getString(7);
request.setAttribute("LastName",LastName);
request.setAttribute("LabTime",LabTime);
...
<col width="80"><col width="80"><col width="80"><col width="80"><col width="60"><col width="60"><col width="80">
<tr>
        <th>Patient Name</th>
        <th>Lab Test Date</th>
        <th>Lab Type</th>
...
<td align="center"><%=request.getAttribute("LabTime") %></td>
