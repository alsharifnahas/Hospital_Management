...
<html lang="en">
    ...
    <body>
        ...
        <center><h1><span class="bold">All Doctors and Departments</span></h1></center>
...
ResultSet rs=st.executeQuery("SELECT * FROM Department, Doctor where Department.DepartmentID=Doctor.DepartmentID order by DepartmentName asc"); 
while(rs.next()) 
{ 
...
<col width="120"><col width="65"><col width="70"><col width="200"><col width="100">
<tr>
    <th>Department</th>
    <th>First Name</th>
    <th>Last Name</th> 
