                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="panel-body" style="margin-top: 80px;height: 100%; width: 100%">  
                                    ...
                                    <form action="Login.jsp" method="post" role="form" class="contactForm lead">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    <label>Login Name</label>
                                                    <input type="text" name="LoginName" required="" placeholder="UserName" id="first_name" title = "Enter Login Name" class="form-control input-md" data-msg="Please enter digits above 250">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password"  required="" placeholder="Password" name="LoginPassword" id="last_name" title ="Enter password" class="form-control input-md" data-rule="minlen:3" data-msg="Please enter at least 3 chars">
                                                    <div class="validation"></div>
                                                </div>
                                            </div>
                                        </div>
