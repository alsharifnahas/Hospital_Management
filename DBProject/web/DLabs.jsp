        ...
        <div class="example3">
            <nav class="navbar navbar-inverse navbar-static-top" style="background-color: whitesmoke;">
                ...
                <!--/.container-fluid -->
                                ...
                                <center><h1><span class="bold">Labs Done</span></h1></center>
...
ResultSet rs=st.executeQuery("SELECT LastName,LabTime, Measurements.Name, Measurements.LowRange, "
        + "MeasuredResults.Value, Measurements.HighRange, MeasuredResults.Comment FROM Patient, "
        + "LabTesting, Measurements, MeasuredResults where Patient.PatientID=LabTesting.PatientID and"
        + " LabTesting.DoneBy='"+DoctorID+"' and Measurements.MeasurementID= MeasuredResults.MeasurementID and"
