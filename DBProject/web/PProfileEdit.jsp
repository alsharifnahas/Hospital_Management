                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="panel-body" background-color:transparent style="margin-top: 100px;margin-left: 100px; width: 100%">
                                    ...
                                    <center><h4>Patient Update Form</h4></center><hr>
                                    <form action="PatientUpdate.jsp"  method="post" name="form" id="form" role="form" class="contactForm lead">
                                        <div class="row" style="margin-top: 0px;">                           
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    <label>Password</label>
                                                    <input type="password" placeholder="Password" id="password" name="LogonPassword" class="form-control input-md" required="" title="complete password">
