...
<html lang="en">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="AllLabs.jsp">View Labs</a></li>
                                    </ul>
                                <li><a href="AddLabs.jsp">Add Lab Results</a></li> 
                            <li class="dropdown">                                
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="PatientName.jsp">Patient Name</a></li>
 ...
 <center><h4 <%=request.getAttribute("reg") %></h4></center>
                                    <img src="dz.jpg" style="width: 100%;margin-top: 20px;height: 80%;" class="img img-responsive" alt="" />                                   
